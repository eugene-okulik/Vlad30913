...
number2 = int(result2[result2.index(':') + 2:]) + 10  # находит индекс символа :  пропуская двоеточие и пробел
number3 = int(result3[result3.index(':') + 2:]) + 10  # находит индекс символа :  пропуская двоеточие и пробел
